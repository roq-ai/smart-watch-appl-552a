...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Smart Watch Application v2`}</title>

        <meta
          name="description"
          content="Experience seamless connectivity and health tracking with Smart Watch Application v2 - Your ultimate companion for time, heart rate, Spo2 and more."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1508685096489-7aacd43bd3b1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzbWFydHdhdGNofGVufDB8fHx8MTY5MzQ2MTA4Mnww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@lloyddirks?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Lloyd Dirks`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Smart Watch Application v2`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless connectivity and health tracking with Smart Watch Application v2 - Your ultimate companion for time, heart rate, Spo2 and more.`}
            </Text>
            <Box
